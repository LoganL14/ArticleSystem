TASK: Write a summary of the article (2512.21227v2) using ONLY the passages provided below.
Guidelines (strict):
1) On the first line, output exactly (no changes): The article is available at: https://arxiv.org/pdf/2512.21227v2
